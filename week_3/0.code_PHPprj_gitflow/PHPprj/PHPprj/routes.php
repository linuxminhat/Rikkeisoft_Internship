...
$router->get('/listings/application/{id}','ListingController@application',['auth']);
$router->get('/listings/apply/{id}','ListingController@create_apply',['auth']);
$router->get('/listings/{id}','ListingController@show');



$router->post('/listings','ListingController@store',['auth']);
$router->post('/listings/apply','ListingController@store_application',['auth']);
