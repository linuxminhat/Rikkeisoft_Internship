...
#Nhuoc diem : Kem linh hoat vi chi co the chay 1 ungdung
#May ao VMs : Máy ảo (VMs) là cách để chạy nhiều ứng dụng trên một máy chủ duy nhất. Mỗi máy ảo chạy trên một hypervisor, là phần mềm mô phỏng phần cứng của máy tính.
#Nhuoc diem Mỗi máy ảo yêu cầu một hệ điều hành đầy đủ, do đó tiêu tốn nhiều tài nguyên và không tối ưu về mặt hiệu năng.
